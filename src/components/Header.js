...
useEffect (() => {
  ...
  const activeClass = "block py-2 px-3 text-white text-2xl bg-blue-700 rounded-sm md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500";
  ...
  return (
    <header>
      <nav className="bg-white border-b-2 border-gray-200 dark:bg-gray-900 dark:border-b-2 dark:border-gray-400">
  <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
  <Link to="" className="flex items-center space-x-3 rtl:space-x-reverse">
      <img src={Logo} className="h-8 bg-white" alt="MC Logo" />
      <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">My Cinematic</span>
  </Link>
